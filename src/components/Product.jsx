          ...
          <div key={detailIndex} className="card-container">
            ...
            <div>
              ...
              {selectedQuantity && getDiscount(selectedQuantity, detail.financials) > 0 && (
                <span>
                  <span>Price/Pack:</span> <s>&#x20b9;{getPrice(selectedQuantity, detail.financials)}</s> &#x20b9;{getDprice(selectedQuantity,detail.financials)} 
                  </span>
              )}
              {selectedQuantity && getDiscount(selectedQuantity, detail.financials) <= 0 && (
                <span>
                  <span>Price/Pack:</span> &#x20b9;{getPrice(selectedQuantity, detail.financials)}
                  </span>
              )}
              <br/>
                 {selectedQuantity && selectedQty > 1 && getDiscount(selectedQuantity, detail.financials) > 0 && (
                <span>
                  <span> Price of {selectedQty} packs:</span> <s>&#x20b9;{getPrice(selectedQuantity, detail.financials) * selectedQty}</s> &#x20b9;{getDprice(selectedQuantity,detail.financials) * selectedQty} 
                  </span>
              )}
              {selectedQuantity && selectedQty > 1  && getDiscount(selectedQuantity, detail.financials) <= 0 && (
                <span>
                  <span> Price of {selectedQty} packs:</span> &#x20b9;{getPrice(selectedQuantity, detail.financials) * selectedQty}
                  </span>
              )}
               {selectedQuantity && getDiscount(selectedQuantity, detail.financials) > 0 && (
